                ...
                <div class="header-right">
                    ...
                    <nav class="header-menu">
                        <div class="header-menu-overlay">
                            ...
                            <a href="cart.html" class="header-link header-menu-cart">
                                ...
                                <svg class="header-cart_count_icon" width="20" height="20">
                                    <circle cx="10" cy="10" r="10" fill="#F16D7F" />
                                    <text x="50%" y="50%" text-anchor="middle" fill="#e8e8e8" font-size="13px" dy=".3em">0</text>
                                </svg>
                            </a>
                        </div>
                    </nav>
