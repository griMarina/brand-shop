<main>
    <section class="breadcrumb">
        <div class="container breadcrumb-container">
            <h1 class="breadcrumb-heading">NEW ARRIVALS</h1>
            ...
            <details class="filter-title">
                ...
                <div>
                    <details class="filter-content" open>
                        <summary class="filter-content-title">CATEGORY</summary>
                    ...
                    <details class="filter-content">
                        <summary class="filter-content-title">BRAND</summary>
                        <ul class="filter-content-list">
                    ...
                    <details class="filter-content">
                        <summary class="filter-content-title">DESIGNER</summary>
                        <ul class="filter-content-list">
