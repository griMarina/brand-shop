    ...
    <section class="breadcrumb">
        <div class="container account-nav">
            <div class="account-nav-top">
                <p class="account-nav-top-heading">Hi, username!</p>
                <a class="account-nav-logout logout-mob" href="/"><span>Logout</span></a>
            </div>
            ...
            <a class="account-nav-logout logout-desk" href="/"><span>Logout</span></a>
        </div>
    </section>
    <section class="account container">
        <h2 class="account-header">Order </h2>
        <div>
            <div class="cart-item">
                ...
                <div class="cart-item-description">
                    <div class="cart-item-description-top">
                        <h3 class="cart-item-title"><?= $product->get_title() ?></h3>
