                    ...
                    <div class="cart-item">
                        ...
                        <div class="cart-item-description">
                            <div class="cart-item-description-top">
                                ...
                                <button class="cart-item-delete" type="button"><svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" onclick="deleteProduct(<?= $product['id'] ?>)">
                            ...
                            <li>Size: Xl</li> -->
                                <li>Quantity:
                                    ...
                                    <span class="cart-item-quantity" data-id="<?= $product['id'] ?>"><?= $product['quantity'] ?></span>
