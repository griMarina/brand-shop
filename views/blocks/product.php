<main>
    ...
    <section class="description container">
        ...
        <button class="description-cart-button" type="button" onclick="addToCart(<?= $product['id'] ?>)"><svg class="description-cart-button-icon" width="32" height="29" viewBox="0 0 32 29" xmlns="http://www.w3.org/2000/svg">
