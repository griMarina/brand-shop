<main>
    ...
    <section class="product-slider">
        ...
        <picture class="product-slider-image">
            <source srcset="/img/slide-small/<?= $product->get_title() ?>-slide-1-small.jpg" media="(max-width: 788px)">
            <!-- <source srcset="/img/<?= $image->get_title() ?>-medium.jpg" media="(max-width: 1192px)"> -->
            <img src="/img/slide-big/<?= $image->get_title() ?>-slide-1-big.jpg" alt="<?= $image->get_title() ?>">
        </picture>
    ...
    <section class="description container">
        ...
        <span class="description-pricetag">$<?= $product->get_price() ?></span>
        ...
        <button class="description-cart-button" type="button" onclick="addToCart('<?= $product->get_id() ?>')"><svg class="description-cart-button-icon" width="32" height="29" viewBox="0 0 32 29" xmlns="http://www.w3.org/2000/svg">
