<main>
    ...
    <section class="reg container">
        ...
        <section>
            ...
            <form class="reg-form">
                <fieldset class="reg-form-heading">
                    Your Name
                    <input class="reg-form-info" type="text" placeholder="First Name" required>
                    <input class="reg-form-info" type="text" placeholder="Last Name">
                </fieldset>
                ...
                <fieldset class="reg-form-heading">
                    Login details
                    <input class="reg-form-info" type="email" placeholder="Email" required>
                    <input class="reg-form-info" type="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                </fieldset>
                <p class="reg-form-text">Please use 8 or more characters, with at least 1 number and a mixture
                    of
        ...
        <aside class="reg-perks">
            ...
            <p class="reg-perks-text">Get in on the loyalty program where you can earn points and unlock serious
